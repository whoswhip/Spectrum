...
namespace Spectrum
{
    partial class Renderer : Overlay
    {
        ...
        private System.Drawing.Point _previewStartPoint = new(100, 100);
        private System.Drawing.Point _previewEndPoint = new(400, 300);
        private List<(System.Drawing.Point point, double speed)> _previewPath = [];
        ...
        private void RenderMovementPreview()
        {
            ...
            if ((DateTime.Now - _lastPreviewUpdate).TotalMilliseconds > UpdatePreviewInterval)
            {
                ...
                System.Drawing.Point current = _previewStartPoint;
                int steps = 0;
                int maxSteps = 10000;
                ...
                while (true)
                {
                    ...
                    if (distance < config.WindMouseTargetArea || steps++ >= maxSteps)
                        break;
                    System.Drawing.Point nextPoint = config.AimMovementType switch
                    {
